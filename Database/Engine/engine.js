        ...
        socket.on("subserverMessage", function (data) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_u) {
                switch (_u.label) {
                    ...
                    case 1:
                        _u.sent();
                        return [2 /*return*/, socket.emit("ok", {
                                method: "addUser",
                                message: "user added",
                                shortcut: (_b = data.shortcut) !== null && _b !== void 0 ? _b : {},
                            })];
                    case 2:
                        if (!(data.method === "getUserById")) return [3 /*break*/, 4];
                        return [4 /*yield*/, controller_1.theUserHandler.getUserById(data.id)];
                    case 3:
                        _res = _u.sent();
                        return [2 /*return*/, socket.emit("ok", __assign(__assign({ method: "getUserById" }, _res), { shortcut: (_c = data.shortcut) !== null && _c !== void 0 ? _c : {} }))];
                    case 4:
                        if (!(data.method === "chargeUser")) return [3 /*break*/, 6];
                    ...
                    case 6:
                        if (!(data.method === "dechargeUser")) return [3 /*break*/, 8];
                    ...
                    case 8:
                        if (!(data.method === "changeBuyMode")) return [3 /*break*/, 10];
                    ...
                    case 10:
                        if (!(data.method === "getPortByName")) return [3 /*break*/, 12];
                        return [4 /*yield*/, portController.getPortByName(data.name)];
                    case 11:
                        _res = _u.sent();
                        return [2 /*return*/, socket.emit("ok", __assign(__assign({ method: "getPortByName" }, _res), { shortcut: (_g = data.shortcut) !== null && _g !== void 0 ? _g : {} }))];
                    case 12:
                        if (!(data.method === "getPortByChat")) return [3 /*break*/, 14];
                        return [4 /*yield*/, portController.getPortByChat(data.name)];
                    case 13:
                        _res = _u.sent();
                        return [2 /*return*/, socket.emit("ok", __assign(__assign({ method: "getPortByChat" }, _res), { shortcut: (_h = data.shortcut) !== null && _h !== void 0 ? _h : {} }))];
                    case 14:
                        if (!(data.method === "banPortByName")) return [3 /*break*/, 16];
                        return [4 /*yield*/, portController.banPortByName(data.name)];
                    case 15:
                        _res = _u.sent();
                        return [2 /*return*/, socket.emit("ok", __assign(__assign({ method: "banPortByName" }, _res), { shortcut: (_j = data.shortcut) !== null && _j !== void 0 ? _j : {} }))];
                    case 16:
                        if (!(data.method === "unbanPortByName")) return [3 /*break*/, 18];
                        return [4 /*yield*/, portController.unbanPortByName(data.name)];
                    case 17:
                        _res = _u.sent();
                        return [2 /*return*/, socket.emit("ok", __assign(__assign({ method: "unbanPortByName" }, _res), { shortcut: (_k = data.shortcut) !== null && _k !== void 0 ? _k : {} }))];
                    case 18:
                        if (!(data.method === "banPortByChat")) return [3 /*break*/, 20];
                        return [4 /*yield*/, portController.banPortByChat(data.chat)];
                    case 19:
                        _res = _u.sent();
                        return [2 /*return*/, socket.emit("ok", __assign(__assign({ method: "banPortByChat" }, _res), { shortcut: (_l = data.shortcut) !== null && _l !== void 0 ? _l : {} }))];
                    case 20:
                        if (!(data.method === "unbanPortByChat")) return [3 /*break*/, 22];
                        return [4 /*yield*/, portController.unbanPortByChat(data.chat)];
                    case 21:
                        _res = _u.sent();
                        return [2 /*return*/, socket.emit("ok", __assign(__assign({ method: "unbanPortByChat" }, _res), { shortcut: (_m = data.shortcut) !== null && _m !== void 0 ? _m : {} }))];
                    case 22:
                        if (!(data.method === "addPort")) return [3 /*break*/, 24];
                        return [4 /*yield*/, portController.addPort(data.owner, data.chat, data.expires)];
                    case 23:
                        _res = _u.sent();
                        return [2 /*return*/, socket.emit("ok", __assign(__assign({ method: "addPort" }, _res), { shortcut: (_o = data.shortcut) !== null && _o !== void 0 ? _o : {} }))];
                    case 24:
                        if (!(data.method === "removePortByName")) return [3 /*break*/, 26];
                        return [4 /*yield*/, portController.removePortByName(data.name)];
                    case 25:
                        _res = _u.sent();
                        return [2 /*return*/, socket.emit("ok", __assign(__assign({ method: "removePortByName" }, _res), { shortcut: (_p = data.shortcut) !== null && _p !== void 0 ? _p : {} }))];
                    case 26:
                        if (!(data.method === "removePortByOwner")) return [3 /*break*/, 28];
                        return [4 /*yield*/, portController.removePortByOwner(data.chat)];
                    case 27:
                        _res = _u.sent();
                        return [2 /*return*/, socket.emit("ok", __assign(__assign({ method: "removePortByOwner" }, _res), { shortcut: (_q = data.shortcut) !== null && _q !== void 0 ? _q : {} }))];
                    case 28:
                        if (!(data.method === "readPrice")) return [3 /*break*/, 30];
                    ...
                    case 30:
                        if (!(data.method === "changePrice")) return [3 /*break*/, 32];
                    ...
                    case 32: return [2 /*return*/, socket.emit("error", {
                            message: "input error",
